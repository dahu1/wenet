...
def get_args():
    ...
    parser.add_argument('--broke_save',
                        action='store_true',
                        help='if training progress is broken ,save the model',
                        default=False)
...
def main():
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        try:
            ...
            if args.broke_save  and args.rank == 0:
                save_model_path = os.path.join(model_dir, '{}_stop.pt'.format(epoch))
                save_checkpoint(
